    ...
    <div className="bg-[#F9F8F6] pt-[88px]">
      <div className="max-w-[800px] mx-auto px-6 md:px-10 py-12">
        ...
        <div className="prose prose-sm max-w-none mt-8 space-y-4 text-[13px] leading-relaxed text-[#73706B]">
          ...
          <p>Puedes solicitar acceso, rectificación o eliminación escribiendo a <a href={`mailto:${(import.meta.env.VITE_CONTACT_EMAIL || "silmtech716@gmail.com")}`} className="underline">{(import.meta.env.VITE_CONTACT_EMAIL || "silmtech716@gmail.com")}</a>. Respondemos en 24h (compromiso).</p>

          ...
          <div className="mt-8 space-y-0 border-t border-[#E0DDD6]">
            {[
              ...
              <div key={c.l} className="flex justify-between items-center py-3.5 border-b border-[#E0DDD6]">
                ...
                {c.href ? <a href={c.href} target={c.l === 'Instagram' ? '_blank' : undefined} rel={c.l === 'Instagram' ? 'noopener noreferrer' : undefined} className="text-[13px] font-medium hover:underline underline-offset-4">{c.v}</a> : <span className="text-[13px] font-medium">{c.v}</span>}
              </div>
            ))}
          </div>
